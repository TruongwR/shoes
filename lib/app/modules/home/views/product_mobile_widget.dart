...
class ProductMobileWidget extends GetView<HomeController> {
  const ProductMobileWidget({super.key});
            ...
            children: [
              Container(
                ...
                child: Column(
                    ...
                    crossAxisAlignment: CrossAxisAlignment.start,
                    children: [
                      ImageLoader.image('ic_nike', size: 24),
                      const Row(
                        children: [
                          Text(
                            "Our Products",
                  ...
                  child: ListView.builder(
                    ...
                    itemBuilder: (context, index) {
                      ...
                      for (int i = 0; i < listData.length; i++) {
                        log('index $i ${listData[i].hasCart}');
                      }
                      return Column(
                        mainAxisAlignment: MainAxisAlignment.start,
                            ...
                            children: [
                              ...
                              AnimatedSwitcher(
                                ...
                                child: hasCart
                                    ? ElevatedButton(
                                        onPressed: () {
                                          controller.listShoesInCart.add(item.copyWith(quantity: 1));
                                          controller.listData[index].hasCart = true;
                                          controller.listData.refresh();
                                          controller.caculator();
                                        },
                                        style: ButtonStyle(
                                          padding: MaterialStateProperty.all<EdgeInsetsGeometry>(
                                            const EdgeInsets.all(2.0), // Thêm padding 16.0 pixel cho nút
                                          ),
                                          backgroundColor: MaterialStateProperty.all(const Color(0xfff6c90e)),
                                        ...
                                        child: const Text(
                                          'ADD TO CARD',
                                          style:
                                              TextStyle(fontSize: 8, color: Colors.black, fontWeight: FontWeight.w700),
                                        ),
                                      )
                                    : const InkWell(
                                        child: CircleAvatar(
